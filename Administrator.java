...
public class Administrator extends User {
    ...
    public static void main(String[] args) {
        Administrator admin =new Administrator("OREO",true);
        admin.displayMenu();
    }
    ...
    private List<String[]> sortList(List<String[]> list, boolean ascending) {
        ...
        sortedList.add(header); // Add header
        sortedList.addAll(data); // Add sorted data
            ...
            switch (choice) {
                ...
                case 4: String newID = assignID(role);
                        if (newID!=null && patientManage.add(newID) && userManage.add(newID))
                        {
                            ...
                            hospital.writeStaff(patientList,this);
                        }
                        break;
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 4: System.out.print("Enter Role: ");
                        ...
                        if (newID!=null&&staffManage.add(newID, role) && userManage.add(newID))
                        {
                            sortList(userList, true);
