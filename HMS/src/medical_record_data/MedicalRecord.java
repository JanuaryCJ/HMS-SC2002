/*
represents medicalrecord, so a doctor can edit and view a patient's MedicalRecord, 
and a patient can view his medical record and change the non-medical records, which is Email and Number
@author Tang Ruixuan
@version 1.0
@since 19/11/2024
*/
...
@param String ID, String Patient, String DOB, String Gender, String BloodType, String Email,
...
/*below are the setter and getter for all attributes of medical record
*/
public String getID() {
    return ID;
}
